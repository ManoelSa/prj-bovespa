...
AmazonS3_node1749690961519 = glueContext.create_dynamic_frame.from_options(format_options={}, connection_type="s3", format="parquet", connection_options={"paths": [s3_bucket], "recurse": True}, transformation_ctx="AmazonS3_node1749690961519")
...
'''
SQLQuery_node1749692597878 = sparkSqlQuery(glueContext, query = SqlQuery6962, mapping = {"myDataSource":DropDuplicates_node1749691095632}, transformation_ctx = "SQLQuery_node1749692597878")
