...
quarter(dt_ref) as trimestre,
datediff(current_date(), dt_ref) as dias_processamento
from myDataSource m
'''
...
ChangeSchema_node1749691305107 = ApplyMapping.apply(frame=SQLQuery_node1749692597878, mappings=[("segment", "string", "setor", "string"), ("cod", "string", "codigo", "string"), ("asset", "string", "acao", "string"), ("type", "string", "tipo", "string"), ("part", "decimal", "part", "double"), ("partAcum", "decimal", "part_acum", "double"), ("theoricalQty", "long", "qtd_teorica", "bigint"), ("dt_ref", "string", "dt_ref", "date"), ("trimestre", "int", "trimestre", "int"), ("ano_ref", "int", "ano_ref", "int"), ("mes_ref", "int", "mes_ref", "int"), ("dias_processamento", "int", "dias_processamento", "int")], transformation_ctx="ChangeSchema_node1749691305107")

# Script generated for node Aggregate
Aggregate_node1749691185039 = sparkAggregate(glueContext, parentFrame = ChangeSchema_node1749691305107, groups = ["setor", "acao", "dt_ref", "codigo", "trimestre", "ano_ref", "mes_ref", "dias_processamento"], aggs = [["qtd_teorica", "sum"]], transformation_ctx = "Aggregate_node1749691185039")
...
AmazonS3_node1749691627621.setCatalogInfo(catalogDatabase="default",catalogTableName="bovespa")
